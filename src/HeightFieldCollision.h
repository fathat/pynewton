...
class HeightFieldCollision 
{
	...
	public:
	HeightFieldCollision( NewtonWorld* nWorld, int size, dFloat cellSize, const dFloat* heightvals );
	...
	dFloat CellSize() { return m_cellSize; }
	...
	dVector m_minBox;
	dVector m_maxBox;
	dFloat** m_heightField;
	CellFlags** m_edgeFlags;
